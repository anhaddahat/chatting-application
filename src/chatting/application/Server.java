...
public class Server implements ActionListener {
    ...
    Server() {
        ...
        p1.setBackground(new Color(39, 78, 116));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/superman.png"));
...
//        p1.add(phone);
        ...
        JLabel name = new JLabel("Superman");
        ...
        status.setFont(new Font("Times_New_Roman", Font.PLAIN, 13));
        p1.add(status);
        ...
        send.setBackground(new Color(39, 78, 116));
        send.setBorderPainted(false);
        send.addActionListener(this);
        send.setFont(new Font("Times_New_Roman", Font.PLAIN, 16));
        f.add(send);
